require.config({
    ...
    paths: {
        ...
        bootstrap: ['//maxcdn.bootstrapcdn.com/bootstrap/3.2.0/js/bootstrap.min', 'libs/bootstrap/dist/js/bootstrap.min', 'app/bootstrap.min'],
        async: 'libs/requirejs-plugins/src/async',
        maplabel: 'libs/google-maps-utility-library-v3/maplabel/src/maplabel'
    },
    shim: {
        'bootstrap': {
            'deps': ['jquery']
